...
class CustomBarController: UITabBarController {
    ...
    open override var selectedViewController: UIViewController? {
        willSet {
            ...
            guard let tabBar = tabBar as? CustomTabBar, let index = viewControllers?.firstIndex(of: newValue) else {return}
    ...
    open override func viewDidLoad() {
        ...
        circleView.backgroundColor = Colors.independence
        ...
        circleImageView.tintColor = Colors.cadetGrey
